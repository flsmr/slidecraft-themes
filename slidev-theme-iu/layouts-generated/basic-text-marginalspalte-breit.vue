...
<template>
  <div class="slidev-layout iu-basic-text-marginalspalte-breit" style="background:#FFFFFF">
...
<script setup>
// layout: basic-text-marginalspalte-breit
// generated from theme-manifest.json
</script>

<style scoped>
.iu-basic-text-marginalspalte-breit {
  position: relative;
  height: 100%;
  overflow: hidden;
}
