...
<template>
  <div class="slidev-layout iu-basic-text-marginalspalte-schmal" style="background:#FFFFFF">
...
<script setup>
// layout: basic-text-marginalspalte-schmal
// generated from theme-manifest.json
</script>

<style scoped>
.iu-basic-text-marginalspalte-schmal {
  position: relative;
  height: 100%;
  overflow: hidden;
}
