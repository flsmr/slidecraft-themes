<!-- ALIAS layout:image-right -> canonical:basic-text-1-bild-rechts — AUTO-GENERATED — do not edit by hand. -->
<template>
  <div class="slidev-layout iu-image-right" style="background:#FFFFFF">
    <img class="shape shape--custgeom shape--bildplatzhalter-16"
         src="/assets/shapes/basic-text-1-bild-rechts__Bildplatzhalter-16.svg"
         style="left:42.3200%;top:23.1300%;width:57.6800%;height:68.8600%" alt="">
    <div class="textbox textbox--picture-0"
         style="left:42.3200%;top:23.1300%;width:57.6800%;height:68.8600%">
      <slot name="picture-0"><span /></slot>
    </div>
    <div class="textbox textbox--default"
         style="left:3.6300%;top:22.2000%;width:30.6900%;height:69.7900%;background:transparent;font-family:'Source Sans Pro',system-ui,sans-serif;font-weight:400;font-style:normal;font-size:calc(17.0 / 540 * 100vh);color:inherit;text-align:left;display:flex;align-items:flex-start;width: 30.6900%; overflow-wrap: break-word; hyphens: auto">
      <slot><span /></slot>
    </div>
...
<script setup>
// layout: image-right (alias of basic-text-1-bild-rechts)
