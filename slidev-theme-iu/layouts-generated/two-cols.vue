<!-- ALIAS layout:two-cols -> canonical:basic-text-2-spalten — AUTO-GENERATED — do not edit by hand. -->
<template>
  <div class="slidev-layout iu-two-cols" style="background:#FFFFFF">
...
<script setup>
// layout: two-cols (alias of basic-text-2-spalten)
