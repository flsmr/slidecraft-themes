<!-- ALIAS layout:agenda -> canonical:basic-text-2-spalten — AUTO-GENERATED — do not edit by hand. -->
<template>
  <div class="slidev-layout iu-agenda" style="background:#FFFFFF">
...
<script setup>
// layout: agenda (alias of basic-text-2-spalten)
